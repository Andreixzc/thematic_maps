...
class WaterQualityProcessorMedian:
    ...
    def process_reservoir(self, reservoir_name, aoi, date_range, n_tiles=2, output_dir='outputs'):
        ...
        output_filename = f"{reservoir_name}_{date_str}_chlorophyll.tif"
        ...
        stats_filename = f"{reservoir_name}_{date_str}_stats.txt"
...
if __name__ == "__main__":
    ...
    # Process Três Marias
    print("Processing Três Marias reservoir (median for the period)...")
    output_tiff_tres_marias, output_stats_tres_marias = processor.process_reservoir(
        reservoir_name="Tres_Marias",
        aoi=aoi_tres_marias,
        date_range=['2020-01-01', '2020-03-01'],
        output_dir='water_analyses/tres_marias_median'
    )
    
    print("Três Marias median processing complete!")
    print(f"GeoTIFF saved to: {output_tiff_tres_marias}")
    print(f"Statistics saved to: {output_stats_tres_marias}")
    print("---")
    
    # Process Furnas
    print("\nProcessing Furnas reservoir (median for the period)...")
    output_tiff_furnas, output_stats_furnas = processor.process_reservoir(
        reservoir_name="Furnas",
        aoi=aoi_furnas,
        date_range=['2020-01-01', '2020-03-01'],
        output_dir='water_analyses/furnas_median'
    )
    
    print("Furnas median processing complete!")
    print(f"GeoTIFF saved to: {output_tiff_furnas}")
    print(f"Statistics saved to: {output_stats_furnas}")
    print("---")

    print("All median water quality analyses complete!")